...
echo_delay = np.loadtxt('./E6945_DELAY.txt')
echo_no_delay = np.loadtxt('./E6945_NO_DELAY.txt')
song1_dpcm_subs = np.loadtxt('./song3_DPCM_Subs')
song1_dpcm_samples = np.loadtxt('./song3_DPCM_Samples')
generator_dpcm_samples = np.loadtxt('generator_DPCM_Samples')
song1_aqdpcm_samples = np.loadtxt('./song3_AQ-DPCM_Samples')
song1_aqdpcm_subs = np.loadtxt('./song3_AQ-DPCM_Subs')
song1_aqdpcm_m = np.loadtxt('./song3_AQ-DPCM_M')
song2_aqdpcm_m = np.loadtxt('./song4_AQ-DPCM_M')
song1_aqdpcm_b = np.loadtxt('./song3_AQ-DPCM_B')
song2_aqdpcm_b = np.loadtxt('./song4_AQ-DPCM_B')
output_dir = '../../graphs/session2/'
dpi = 100
...
plt.ylabel("throuput average for 8s")
plt.plot(g4_data)
plt.savefig(output_dir+'G4.png', transparent=True)
plt.close()
...
plt.savefig(output_dir+'G5.png', transparent=True)
plt.close()
...
plt.xlabel("response time in ms")
plt.ylabel("number of packets")
plt.savefig(output_dir+'G6.png', transparent=True)
plt.close()
...
plt.xlabel("response time in ms")
plt.ylabel("number of packets")
plt.savefig(output_dir+'G7.png', transparent=True)
plt.close()
...
plt.xlabel("response time in ms")
plt.ylabel("number of packets")
plt.savefig(output_dir+'G8.png', transparent=True)
plt.close()
...
plt.legend()
plt.savefig(output_dir+'R1.png', transparent=True)
plt.close()
...
plt.savefig(output_dir+'G9.png', transparent=True)
plt.close()
...
plt.savefig(output_dir+'G10.png', transparent=True)
plt.close()
...
plt.savefig(output_dir+'G11.png', transparent=True)
plt.close()
...
plt.savefig(output_dir+'G12.png', transparent=True)
plt.close()
...
plt.savefig(output_dir+'G13.png', transparent=True)
plt.close()
...
plt.savefig(output_dir+'G14.png', transparent=True)
plt.close()
...
plt.title("G15")
plt.plot(g15_data)
plt.savefig(output_dir+'G15.png', transparent=True)
plt.close()
...
plt.title("G16")
plt.plot(g16_data)
plt.savefig(output_dir+'G16.png', transparent=True)
plt.close()
...
plt.title("G17")
plt.plot(g17_data)
plt.savefig(output_dir+'G17.png', transparent=True)
plt.close()
...
plt.title("G18")
plt.plot(g18_data)
plt.savefig(output_dir+'G18.png', transparent=True)
plt.close()
...
plt.legend()
plt.savefig(output_dir+'G19-G20.png', transparent=True)
plt.close()

# G21
figure(num=None, figsize=(12, 6), dpi=dpi, facecolor='w', edgecolor='k')
with open('./VV9761.json') as f:
    vehicle = json.load(f)
...
plt.legend()
plt.savefig(output_dir+'G21.png', transparent=True)
plt.close()
